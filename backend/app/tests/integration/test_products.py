...
class TestProductEndpoints:
    ...
    def test_create_product_duplicate_sku(self, client: TestClient, db: Session, auth_headers):
    ...
    def test_get_nonexistent_product(self, client: TestClient, db: Session, auth_headers):
    ...
    def test_search_products(self, client: TestClient, db: Session, auth_headers):
        ...
        # Create test products
        products = [
            {"name": "Apple iPhone", "sku": "APPLE-001", "price": 999.00, "quantity": 10},
            {"name": "Samsung Galaxy", "sku": "SAMSUNG-001", "price": 899.00, "quantity": 15},
        ...
        # Search for "Apple"
        response = client.get(
            f"{settings.API_V1_STR}/products/?search=Apple",
            headers=auth_headers
        )
    ...
    def test_filter_by_category(self, client: TestClient, db: Session, auth_headers):
        ...
        products = [
            {"name": "Product 1", "sku": "CAT-001", "price": 10.00, "quantity": 5, "category": "Electronics"},
            {"name": "Product 2", "sku": "CAT-002", "price": 20.00, "quantity": 10, "category": "Clothing"},
            {"name": "Product 3", "sku": "CAT-003", "price": 30.00, "quantity": 15, "category": "Electronics"}
        ]
    ...
    def test_get_low_stock_products(self, client: TestClient, db: Session, auth_headers):
        """Test getting low stock products."""
        # Create products with different stock levels
        products = [
            {"name": "Low Stock", "sku": "LOW-001", "price": 10.00, "quantity": 2, "min_stock": 5},
            {"name": "Good Stock", "sku": "GOOD-001", "price": 20.00, "quantity": 20, "min_stock": 5},
            {"name": "Out of Stock", "sku": "OUT-001", "price": 30.00, "quantity": 0, "min_stock": 10}
        ]
    ...
    def test_product_permissions(self, client: TestClient, db: Session, auth_headers, superuser_headers):
